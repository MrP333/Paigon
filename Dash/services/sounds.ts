...
export const Sounds = {
  jump:       () => tone(300, 0.16, 'sine', 0.2, 0, 620),
  land:       () => noise(0.1, 0.1, 380),
  /** Clipped an obstacle — the descending tone reads as losing ground. */
  obstacleHit: () => { noise(0.16, 0.18, 320); tone(240, 0.2, 'sawtooth', 0.16, 0, 120); },
  bounce:     () => tone(420, 0.2, 'sine', 0.22, 0, 900),
  checkpoint: () => [0, 0.08].forEach((d, i) => tone(700 + i * 260, 0.16, 'sine', 0.2, d)),
  /** Fell off the track. */
  fall:       () => tone(400, 0.5, 'sine', 0.2, 0, 90),
